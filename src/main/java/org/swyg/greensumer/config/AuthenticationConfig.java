...
public class AuthenticationConfig extends WebSecurityConfigurerAdapter {
    ...
    public void configure(WebSecurity web) throws Exception {
        web.ignoring()
                ...
                .antMatchers(HttpMethod.GET, "/api/*/users/existUsername", "/api/v1/posts", "/api/v1/image/*", "/api/*/users/mail")
                .antMatchers(HttpMethod.PUT, "/api/*/users/find/password", "/api/*/users/find/username")
        ;
    }
